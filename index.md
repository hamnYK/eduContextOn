...
<section class="section" style="text-align: center; padding: 60px 0;">
  <img src="{{ '/assets/house_tree_person.svg' | relative_url }}" alt="집, 나무, 사람" style="max-width: 100%; height: auto; max-height: 220px; opacity: 0.95; display: block; margin: 0 auto;" />
</section>
