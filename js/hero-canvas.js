/**
 * Worflogy Hero Canvas — Fractal Network Particle Animation v2
 * 브랜드 컬러(Ink Navy + Living Coral) 기반 지식 그래프 노드 애니메이션
 */
(function () {
  'use strict';
  ...
  const CFG = {
    ...
    speed:       0.55,   /* 기본 이동 속도 */
    mouseRadius: 130,    /* 마우스 인력 반경 (px) */
    mouseForce:  0.022,  /* 인력 세기 */
    damping:     0.990,  /* 속도 감쇠 */
    minR: 2.2,
    maxR: 4.8,
  };
